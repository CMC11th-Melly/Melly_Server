...
import cmc.mellyserver.mellyapi.auth.application.impl.client.dto.KakaoUserData;
	...
	public User getUserData(String accessToken) {
		...
		KakaoUserData kakaoUserResponse = webClient.get()
			...
			.onStatus(HttpStatus::is4xxClientError,
				clientResponse -> Mono.error(new GlobalBadRequestException(ExceptionCodeAndDetails.KAKAO_ACCESS)))
			.onStatus(HttpStatus::is5xxServerError,
				clientResponse -> Mono.error(new TokenValidFailedException("Internal Server error")))
