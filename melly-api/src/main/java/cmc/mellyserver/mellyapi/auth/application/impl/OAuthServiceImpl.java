...
import cmc.mellyserver.mellyapi.auth.application.impl.client.LoginClientFactory;
...
public class OAuthServiceImpl implements OAuthService {
	...
	public AuthResponseForLogin signup(AuthRequestForOAuthSignup authRequestForOAuthSignup) {
		...
		// 있으면 업데이트 하고
		user.updateUser(authRequestForOAuthSignup.getNickname(), authRequestForOAuthSignup.getGender(),
