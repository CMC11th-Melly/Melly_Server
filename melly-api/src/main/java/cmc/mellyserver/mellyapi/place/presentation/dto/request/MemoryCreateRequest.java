package cmc.mellyserver.mellyapi.place.presentation.dto.request;
...
public class MemoryCreateRequest {
	...
	public MemoryCreateRequest(Double lat, Double lng, String placeName, String placeCategory, String title,
		String content, List<String> keyword, Long groupId, OpenType openType, LocalDateTime visitedDate, Long star) {
		this.lat = lat;
		this.lng = lng;
