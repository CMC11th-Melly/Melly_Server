...
public class UserControllerTest extends ControllerTest {
    ...
    class Test_UnderLoginStatus {
        ...
        void getAuthenticatedUserProfile() throws Exception {
            ...
            // given
            given(userProfileService.findNicknameByUserIdentifier(1L)).willReturn("test nickname");
        ...
        void getSurveyResultForSignupUser() throws Exception {
            ...
            perform.andDo(document("get-survey-result",
                    ...
                    responseFields(
                            ...
                            fieldWithPath("data.position.lat").type(JsonFieldType.NUMBER)
                                    .description("lat 좌표"),
                            fieldWithPath("data.position.lng").type(JsonFieldType.NUMBER)
                                    .description("lng 좌표"),
        ...
        void getUpdateProfileData() throws Exception {
            // given
            ProfileUpdateFormResponseDto profileUpdateFormResponseDto = new ProfileUpdateFormResponseDto(
                    "test_image",
                    "test_nickname", Gender.MALE, AgeGroup.TWO);
            given(userService.getLoginUserProfileDataForUpdate(1L)).willReturn(
                    profileUpdateFormResponseDto);
        ...
        void getMemoriesLoginUserCreated() throws Exception {
            ...
            given(userService.findMemoriesLoginUserWrite(any(Pageable.class), anyLong(),
                    any(GroupType.class)))
            ...
            perform.andDo(document("get-group-list",
                    ...
                    responseFields(
                            ...
                            fieldWithPath("data.[].groupId").type(JsonFieldType.NUMBER)
                                    .description("그룹 ID"),
                            fieldWithPath("data.[].groupIcon").type(JsonFieldType.NUMBER)
                                    .description("그룹 아이콘"),
                            fieldWithPath("data.[].groupName").type(JsonFieldType.STRING)
                                    .description("그룹 이름"),
                            fieldWithPath("data.[].users").type(JsonFieldType.NULL)
                                    .description("속해있는 유저 목록"),
                            fieldWithPath("data.[].groupType").type(JsonFieldType.STRING)
                                    .description("그룹 유형"),
                            fieldWithPath("data.[].invitationLink").type(JsonFieldType.STRING)
                                    .description("초대 링크")
                    )));
        }
