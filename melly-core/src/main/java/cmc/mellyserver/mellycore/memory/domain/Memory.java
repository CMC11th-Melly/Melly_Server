...
public class Memory extends JpaBaseEntity {
	...
	@Builder
	public Memory(Long stars, GroupInfo groupInfo, Long userId, String title, String content, OpenType openType,
	...
	public void updateMemory(String title, String content, List<String> keyword, Long groupId, GroupType groupType,
