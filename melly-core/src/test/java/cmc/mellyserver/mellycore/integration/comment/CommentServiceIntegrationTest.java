package cmc.mellyserver.mellycore.integration.comment;
...
//        User mentionedUser = userRepository.save(User.cmc.mellyserver.mellycore.builder().nickname("멘션된 유저").ageGroup(AgeGroup.TWO).build());
//
...
//
//        CommentRequestDto commentRequestDto = CommentRequestDto.cmc.mellyserver.mellycore.builder()
//                .content("테스트 댓글")
//                .userId(user.getId())
...
//        Comment comment = commentService.saveComment(commentRequestDto);
//
//        CommentRequestDto commentRequestDto2 = CommentRequestDto.cmc.mellyserver.mellycore.builder()
//                .content("테스트 댓글")
//                .userId(user.getId())
//                .mentionUserId(mentionedUser.getId())
//                .memoryId(memory.getId())
