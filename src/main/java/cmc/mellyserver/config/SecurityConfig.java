...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/v3/api-docs/**","/api/memory/**","/api/place/list","/api/imageTest","/api/pw","/api/optional","/auth/social/signup","/auth/social","/auth/signup","/auth/login","/auth/nickname","/auth/email","/api/health","/").permitAll()
