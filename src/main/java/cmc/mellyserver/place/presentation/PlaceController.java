...
public class PlaceController {
    ...
    public ResponseEntity<CommonResponse> getPlaceList(@AuthenticationPrincipal User user, @RequestParam(value = "groupType") GroupType groupType)
    {
        ...
        return ResponseEntity.ok(new CommonResponse<>(HttpStatus.OK.value(), MessageConstant.MESSAGE_SUCCESS,PlaceAssembler.markedPlaceReponse(placeReponseDtos)));
    }
    ...
    public ResponseEntity<CommonResponse> getPlaceSearchByMemory(@AuthenticationPrincipal User user, @PathVariable Long placeId)
    {
        ...
        return ResponseEntity.ok(new CommonResponse(HttpStatus.OK.value(), MessageConstant.MESSAGE_SUCCESS, PlaceAssembler.placeResponse(placeResponseDto)));
    }
    ...
    public ResponseEntity<CommonResponse> getDetailPlace(@AuthenticationPrincipal User user, PlaceSimpleRequest placeSimpleRequest)
    {
        ...
        return ResponseEntity.ok(new CommonResponse<>(HttpStatus.OK.value(), MessageConstant.MESSAGE_SUCCESS, PlaceAssembler.placeResponse(placeByPosition)));
    }
}
