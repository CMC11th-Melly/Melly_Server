...
public class MemoryUpdateFormResponseDto {
    ...
    @Builder
    public MemoryUpdateFormResponseDto(List<MemoryImageDto> memoryImages, String title, String content, List<GroupListForSaveMemoryResponseDto> userGroups, Long star, List<String> keywords) {
