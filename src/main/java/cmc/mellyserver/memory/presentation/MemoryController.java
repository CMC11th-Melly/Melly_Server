...
public class MemoryController {
    ...
    {
        List<MemoryFormGroupResponse> userGroup = memoryService.getUserGroupForMemoryForm(Long.parseLong(user.getUsername()));
    ...
    {
        Slice<UserCreatedMemoryListResponseDto> userMemory = memoryService.getUserMemoryInplace(pageable, Long.parseLong(user.getUsername()), placeId, groupType);
    ...
    {
        Slice<UserCreatedMemoryListResponseDto> otherMemory = memoryService.getOtherMemoryInplace(pageable, Long.parseLong(user.getUsername()), placeId, groupType);
   ...
   // TODO : 찐막 수정 완료
    ...
    {
        GetMemoryByMemoryIdResponse memoryByMemoryId = memoryService.getMemoryByMemoryId(Long.parseLong(user.getUsername()), memoryId);
    ...
    {
        List<MemorySearchDto> result = memoryService.searchPlaceByMemoryTitle(Long.parseLong(user.getUsername()), memoryName);
