...
public class MemoryResponse {
    ...
    @Builder
    public MemoryResponse(Long placeId, String placeName, Long memoryId,List<ImageDto> imageDtos, String title, String content, GroupType groupType, String groupName, Long stars, List<String> keyword, boolean loginUserWrite, LocalDateTime visitedDate) {
