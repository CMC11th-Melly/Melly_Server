...
public class MemoryQueryRepository {
    ...
    public MemoryResponseDto getMemoryByMemoryId(Long userSeq, Long memoryId) {
        ...
        Map<Long, List<KeywordResponse>> keywordList = findKeywordList(toMemoryIds(List.of(results)));
        ...
        results.setKeyword(keywordList.get(results.getMemoryId()).stream().map(KeywordResponse::getKeyword).collect(Collectors.toList()));
