 ...
 */
@Data
public class OtherCreatedMemoryListResponseDto {
    ...
    public OtherCreatedMemoryListResponseDto(Long placeId, String placeName, Long memoryId, String title, String content, GroupType groupType, String groupName, Long stars, boolean loginUserWrite, LocalDateTime visitedDate) {
