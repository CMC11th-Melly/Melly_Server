...
public class MemoryDomainService {
    ...
    public Memory createMemory(String uid, Double lat, Double lng, String title, GroupType groupType, String content, int star, OpenType openType,Long groupId,String keyword)
    {
