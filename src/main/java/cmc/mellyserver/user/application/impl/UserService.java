...
import cmc.mellyserver.user.application.SurveyRecommender;
...
public class UserService {
     ...
     */
    public Slice<GetUserMemoryResponse> getUserMemory(Pageable pageable, Long userSeq, GroupType groupType)
    {
      //  User user = authenticatedUserChecker.checkAuthenticatedUserExist(uid);
        Slice<Memory> memories = memoryQueryRepository.searchMemoryUserCreate(pageable, userSeq, null, groupType);
