package cmc.mellyserver.integration.scrap;

import cmc.mellyserver.common.enums.ScrapType;
import cmc.mellyserver.common.exception.GlobalBadRequestException;
import cmc.mellyserver.common.factory.PlaceFactory;
...
public class PlaceScrapServiceIntegrationTest extends IntegrationTest {
    ...
    void find_place_login_user_scraped()
    {
        ...
        CreatePlaceScrapRequestDto createPlaceScrapRequestDto = new CreatePlaceScrapRequestDto(savedUser.getUserSeq(), 1.234, 1.234, ScrapType.FRIEND, "스타벅스", "카페");
        placeScrapService.createScrap(createPlaceScrapRequestDto);

        // when
        Slice<ScrapedPlaceResponseDto> scrapedPlace = placeScrapService.findScrapedPlace(PageRequest.of(0, 10), savedUser.getUserSeq(), null);
    ...
    class When_create_scrap{
        ...
        void add_place_if_place_does_not_exist()
        {
            ...
            Optional<PlaceScrap> placeScrap = placeScrapRepository.findByUserUserSeqAndPlaceId(savedUser.getUserSeq(), place.get().getId());
    ...
    class When_remove_scrap{
        ...
        void remove_scrap(){
            ...
            // then
            Optional<PlaceScrap> result = placeScrapRepository.findByUserUserSeqAndPlaceId(savedUser.getUserSeq(), savedPlace.getId());
