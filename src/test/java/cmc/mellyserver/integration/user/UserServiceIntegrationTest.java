package cmc.mellyserver.integration.user;
...
public class UserServiceIntegrationTest extends IntegrationTest {
    ...
    void get_group_list_user_participated()
    {
        ...
        // when
        List<GroupLoginUserParticipatedResponseDto> result = userService.findGroupListLoginUserParticiated(user.getUserSeq());
    ...
    class When_get_memories_login_user_write{
        ...
        void get_memories_login_user_write_with_no_group_filter()
        {
            ...
            // when
            Slice<MemoryResponseDto> result = userService.findMemoriesLoginUserWrite(PageRequest.of(0, 10), user.getUserSeq(), null);
        ...
        void get_memories_login_user_write_with_group_filter()
        {
            ...
            // when
            Slice<MemoryResponseDto> result = userService.findMemoriesLoginUserWrite(PageRequest.of(0, 10), user.getUserSeq(), GroupType.FRIEND);
    ...
    class When_get_memories_belong_to_my_group_write{
        ...
        void get_memories_belong_to_my_group_write()
        {
            ...
            // when
            Slice<MemoryResponseDto> result = userService.findMemoriesUsersBelongToMyGroupWrite(PageRequest.of(0, 10), group.getId(), user.getUserSeq());
