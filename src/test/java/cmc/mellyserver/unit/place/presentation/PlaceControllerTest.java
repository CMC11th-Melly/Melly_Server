package cmc.mellyserver.unit.place.presentation;
...
public class PlaceControllerTest extends ControllerTest {
    ...
    void show_marker_on_map_where_user_leave_memory_at_least_one() throws Exception {
        ...
        given(placeService.displayMarkedPlace(anyLong(),any(GroupType.class))).willReturn(List.of(markedPlaceResponseDto));
