...
import cmc.mellyserver.user.presentation.dto.response.PlaceScrapCountResponse;
import cmc.mellyserver.user.presentation.dto.response.ScrapedPlaceResponse;
...
import static cmc.mellyserver.common.docs.ApiDocumentUtils.*;
...
public class UserControllerTest extends ControllerTest {
    ...
    class Test_UnderLoginStatus{
        ...
        void getSurveyResultForSignupUser() throws Exception
        {
            ...
            assertThat(dataExtractor.extractDataField(body)).isEqualTo(objectMapper.writeValueAsString(surveyRecommendResponseDto));
        ...
        void getUpdateProfileData() throws Exception
        {
            ...
            assertThat(dataExtractor.extractDataField(body)).isEqualTo(objectMapper.writeValueAsString(profileUpdateFormResponseDto));
        ...
        void getMemoriesLoginUserCreated() throws Exception
        {
           ...
           assertThat(dataExtractor.extractDataField(body)).isEqualTo(objectMapper.writeValueAsString(memoryResponses));
        ...
        void getGroupsLoginUserAssociated() throws Exception
        {
            ...
            List<GroupLoginUserParticipatedResponse> groupLoginUserParticipatedResponses = UserAssembler.groupLoginUserParticipatedResponses(groupLoginUserParticipatedResponseDtos);
            ...
            assertThat(dataExtractor.extractDataField(body)).isEqualTo(objectMapper.writeValueAsString(groupLoginUserParticipatedResponses));
        ...
        void getScrapedPlaceCount() throws Exception
        {
            ...
            List<PlaceScrapCountResponse> placeScrapCountResponses = UserAssembler.placeScrapCountResponses(placeScrapCountResponseDtos);
            ...
            assertThat(dataExtractor.extractDataField(body)).isEqualTo(objectMapper.writeValueAsString(placeScrapCountResponses));
        ...
        void getPlacesUserScraped() throws Exception
        {
            ...
            Slice<ScrapedPlaceResponse> scrapedPlaceResponses = UserAssembler.scrapedPlaceResponses(scrapedPlaceResponseDtoSlice);
            ...
            assertThat(dataExtractor.extractDataField(body)).isEqualTo(objectMapper.writeValueAsString(scrapedPlaceResponses));
            ...
            perform.andDo(document("get-scraped-place",
                    ...
                    responseFields(
                            ...
                            fieldWithPath("data.content.[].myMemoryCount").type(JsonFieldType.NUMBER).description("내가 작성한 메모리 수"),
                            fieldWithPath("data.content.[].otherMemoryCount").type(JsonFieldType.NUMBER).description("다른 사람이 작성한 메모리 수"),
        ...
        void updateProfile() throws Exception
        {
            ...
            MockMultipartFile mockFile = new MockMultipartFile("content",
                    "filename",
                    "multipart/form-data",
                    new FileInputStream("/Users/seojemin/IdeaProjects/Melly_Server/src/test/resources/image/testimage.jpg"));
