...
public class ScrapedPlaceResponse {
    ...
    public ScrapedPlaceResponse(Long placeId, Position position, String placeCategory,
            String placeName,
            String placeImage) {
    ...
    @Builder
    public ScrapedPlaceResponse(Long placeId, Position position, Long myMemoryCount,
            Long otherMemoryCount,
            Boolean isScraped, String placeCategory, String placeName, GroupType recommendType,
            String placeImage) {
        this.placeId = placeId;
        this.position = position;
