...
import cmc.mellyserver.mellyappexternalapi.auth.application.impl.client.dto.AppleUserData;
...
public class AppleClient implements LoginClient {
    ...
    public User getUserData(String accessToken) {
        ...
        AppleUserData response = webClient.get()
                ...
                .onStatus(HttpStatus::is4xxClientError,
                        clientResponse -> Mono.error(new GlobalBadRequestException(
                                ExceptionCodeAndDetails.APPLE_ACCESS)))
                .onStatus(HttpStatus::is5xxServerError,
                        clientResponse -> Mono.error(new GlobalServerException()))
        ...
        try {
            ...
            Claims body = Jwts.parser().setSigningKey(publicKey).parseClaimsJws(accessToken)
                    .getBody();
