...
import cmc.mellyserver.mellyappexternalapi.auth.presentation.dto.request.AuthRequestForSignup;
import cmc.mellyserver.mellyappexternalapi.auth.presentation.dto.request.CommonSignupRequest;
import cmc.mellyserver.mellyappexternalapi.auth.presentation.dto.request.OAuthLoginRequest;
...
import cmc.mellyserver.mellyappexternalapi.auth.presentation.dto.response.OAuthLoginResponse;
import cmc.mellyserver.mellyappexternalapi.auth.presentation.dto.response.SignupResponse;
...
public class AuthAssembler {
    ...
    public static CommonResponse authUserDataResponse(User user) {
        return new CommonResponse(200, "인증 유저 정보",
