package cmc.mellyserver.domain.memory.application;
...
public class MemoryServiceIntegrationTest extends IntegrationTest {
	...
	//
	// Memory memory = Memory.cmc.mellyserver.mellycore.builder().title("테스트
	// 제목").content("테스트 컨텐츠")
	...
	//
	// // when
	// List<FindPlaceInfoByMemoryNameResponseDto> memories =
	// memoryService.findPlaceInfoByMemoryName(
	...
	// CreateGroupRequestDto.cmc.mellyserver.mellycore.builder()
	// .id(user.getId())
	// .groupName("테스트 그룹")
	...
	//
	// UpdateMemoryRequestDto updateMemoryRequestDto =
	// UpdateMemoryRequestDto.cmc.mellyserver.mellycore.builder()
	// .id(user.getId())
	...
	//
	// CreateMemoryRequestDto createMemoryRequestDto1 =
	// CreateMemoryRequestDto.cmc.mellyserver.mellycore.builder()
	...
	// .build();
	//
	// CreateMemoryRequestDto createMemoryRequestDto2 =
	// CreateMemoryRequestDto.cmc.mellyserver.mellycore.builder()
	...
	// .build();
	//
	// CreateMemoryRequestDto createMemoryRequestDto3 =
	// CreateMemoryRequestDto.cmc.mellyserver.mellycore.builder()
	...
	//
	// // when
	// Slice<MemoryResponseDto> loginUserWriteMemoryBelongToPlace =
	// memoryService.findLoginUserWriteMemoryBelongToPlace(
	...
	// // when
	// Slice<MemoryResponseDto> loginUserWriteMemoryBelongToPlace =
	// memoryService.findOtherUserWriteMemoryBelongToPlace(
	// PageRequest.of(0, 10), user.getId(), place.getPlaceId(), null);
	//
	// // then
	...
	// // when
	// Slice<MemoryResponseDto> loginUserWriteMemoryBelongToPlace =
	// memoryService.findMyGroupMemberWriteMemoryBelongToPlace(
	// PageRequest.of(0, 10), user.getId(), place.getPlaceId(), null);
	//
	// // then
	// assertThat(loginUserWriteMemoryBelongToPlace.getContent()).hasSize(2);
	...
	// }
	//
	// @DisplayName("메모리를 새로 작성하고, 아직 장소 정보가 DB에 없을때 함께하는 그룹으로 설정한 그룹이 DB에 존재하지 않으면 예외를
	// 발생시킨다.")
	// @Test
	...
	// }
	//
	// @DisplayName("메모리를 새로 작성하고, 장소 정보가 DB에 있을때 함께하는 그룹으로 설정한 그룹이 DB에 존재하지 않으면 예외를
	// 발생시킨다.")
	// @Test
	...
	// groupService.participateToGroup(nonLoginUser.getId(), userGroup.getId());
	//
	// CreateMemoryRequestDto resultWithExistGroup =
	// CreateMemoryRequestDto.cmc.mellyserver.mellycore.builder()
	// .id(user.getId()).title("테스트 제목1")
	// .groupId(userGroup.getId())
	// .content("테스트 컨텐츠1").placeName("테스트 장소")
	...
	//
	// // when then
	// CreateMemoryRequestDto resultWithoutExistGroup =
	// CreateMemoryRequestDto.cmc.mellyserver.mellycore.builder()
	// .id(user.getId()).title("테스트 제목1")
	// .groupId(3L)
	// .content("테스트 컨텐츠1").placeName("테스트 장소")
