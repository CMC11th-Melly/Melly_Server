...
public class AsyncConfig implements AsyncConfigurer {
     ...
     * <p>
     * 이 방식은 사용자 요청이 몰리는 상황에서는 쓰레드 생성으로 인한 리소스 낭비가 발생합니다. 따라서 미리 쓰레드를 생성해두는 ThreadPoolTaskExecutor를 사용합니다. ThreadPoolTaskExecutor는
     * java.util.concurrent package의 ThreadPoolExecutor를 더 편하게 사용하기 위한 Spring의 클래스입니다.
     * <p>
