...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	List<User> findByLastLoginDateTimeBeforeAndUserStatusEquals(final LocalDateTime localDateTime,
			final UserStatus status);

	List<User> findByPwInitDateTimeBeforeAndPasswordExpiredEquals(final LocalDateTime localDateTime,
			final PasswordExpired passwordExpired);
